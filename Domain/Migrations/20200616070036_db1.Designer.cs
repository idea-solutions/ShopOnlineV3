...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("DateAdd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 14, 0, 36, 304, DateTimeKind.Local).AddTicks(125));
            ...
            modelBuilder.Entity("Domain.Models.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 14, 0, 36, 317, DateTimeKind.Local).AddTicks(1162));
            ...
            modelBuilder.Entity("Domain.Models.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 16, 14, 0, 36, 328, DateTimeKind.Local).AddTicks(4483));
            ...
            modelBuilder.Entity("Domain.Models.Entities.OrderDetail", b =>
                {
                    b.HasOne("Domain.Models.Entities.Order", "Oder")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.Entities.TypeProduct", "TypeProduct")
                        .WithMany("OrderDetails")
